...
public class CuentaCorriente { 
    private String numero; //en esta sección estaba casi todo bien, solo puse private en variables.
    private int saldo; //removí el = 0, se añade más abajo.

    public CuentaCorriente(String numeroCuenta) {//añadir if validación
    ...
    public String getNumeroCuenta() { return numero; }
